...
//						Log.Warning(ELogGroup.Core, "Added Player Loop System: {0} to: {1} position: {2}/{3}", playerLoopSystemType.FullName, subSystem.type.FullName, position, subSubSystems.Count - 1);
					}
					else
					{
						subSubSystems.Add(targetSystem);
//						Log.Warning(ELogGroup.Core, "Added Player Loop System: {0} to: {1} position: {2}/{2}", playerLoopSystemType.FullName, subSystem.type.FullName, subSubSystems.Count - 1);
					}
...
//							Log.Warning(ELogGroup.Core, "Added Player Loop System: {0} to: {1} before: {2}", playerLoopSystemType.FullName, subSystem.type.FullName, subSubSystem.type.FullName);
...
//							Log.Warning(ELogGroup.Core, "Added Player Loop System: {0} to: {1} after: {2}", playerLoopSystemType.FullName, subSystem.type.FullName, subSubSystem.type.FullName);
						}
...
//						Log.Warning(ELogGroup.Core, "Removed Loop System: {0} from: {1}", playerLoopSystemType.FullName, subSystem.type.FullName);
					}
				}
		...
		public static void DumpPlayerLoopSystems()
		{
			...
			//	Log.Warning(ELogGroup.Core, subSystem.type.FullName);

			//	List<PlayerLoopSystem> subSubSystems = new List<PlayerLoopSystem>(subSystem.subSystemList);
			//	for (int j = 0; j < subSubSystems.Count; ++j)
			//	{
			//		Log.Info(ELogGroup.Core, "    " + subSubSystems[j].type.FullName);
			//	}
			//}
