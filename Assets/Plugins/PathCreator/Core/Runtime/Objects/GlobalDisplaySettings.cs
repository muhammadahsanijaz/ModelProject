...
namespace PathCreation
{
	...
	public class GlobalDisplaySettings : ScriptableObject
	{
		...
		public Color anchorHighSpeedColor = Color.green;
		public Color anchorLowSpeedColor = Color.red;
		...
		public Color vertexPathLowSpeed = Color.red;
		public Color vertexPathHighSpeed = Color.green;
