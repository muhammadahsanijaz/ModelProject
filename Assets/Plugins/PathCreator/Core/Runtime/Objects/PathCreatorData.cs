...
namespace PathCreation {
    ...
    public class PathCreatorData {
        ...
        public float vertexPathMaxAngleError = 8f;
        public float vertexPathMinVertexSpacing = 1f;
        public float vertexPathMaxVertexSpacing = 10f;
        ...
        public VertexPath GetVertexPath (Transform transform) {
            ...
            if (!vertexPathUpToDate || _vertexPath == null) {
                ...
                _vertexPath = new VertexPath (bezierPath, transform, vertexPathMaxAngleError, vertexPathMinVertexSpacing, vertexPathMaxVertexSpacing);
            }
            return _vertexPath;
        }
